...
export const CALENDAR_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => AlCalendarComponent),
    multi: true,
};
...
@Component({
    selector: 'al-calendar',
    templateUrl: './al-calendar.component.html',
    animations: [
...
export class AlCalendarComponent
    ...
    implements OnInit, OnDestroy, ControlValueAccessor
{
    ...
    @Input() selectButtonStyleClass = 'ui-button-secondary';
    ...
    @Output() onSelectDateClick: EventEmitter<any> = new EventEmitter();
    ...
    private _locales: { uk: any; ru: any; en: any } = {
        uk: {
            closeText: 'Закрити',
            clear: 'Очистити',
            today: 'Сьогодні',
    ...
    get locale() {
        return (
            this._locales[this.translateService.currentLang] || this._locales.uk
        );
    }
    ...
    updateValue(value, markAsTouched: boolean = true) {
        if (markAsTouched) {
            this.markAsTouched();
        }
        if (!this.disabled) {
            this.hideOverlay();
            this.onSelectDateClick.emit(this.value);
